        ...
        <div className="fixed z-10 bg-[#ffffb4] rounded-xl border-2 border-black w-[30%] 2xl:w-[25%] left-[35%] top-[40%] px-4 opacity-100">
          ...
          <div className="flex flex-col font-acme">
            ...
            <div className="ml-[30%] w-[50%] relative">
              <input className="w-[80%] border-none focus:outline-none bg-slate-100 pl-[10%] 2xl:pl-[15%] font-acme rounded-xl my-5 py-1 text-[1.5rem]" type="number" value={slippage.displayString} 
                onChange={(e) => {
                  if(!e.target.value) {
