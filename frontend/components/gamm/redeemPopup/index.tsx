...
export const RedeemPopup = ({ popupToggle, setPopupToggle }: PopupProps) => {

  return (
    <>
      { popupToggle && 
        <div className="z-10 bg-white rounded-xl border-2 border-black w-36 h-36 left-[80%] lg:left-[55%] top-[30%] absolute px-4">
          <span 
