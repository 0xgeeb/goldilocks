...
export const StatsBox = () => {
  ...
  return (
    <div className="w-[40%] h-[75%] bg-white border-2 border-black rounded-xl flex flex-col p-3 2xl:p-6">
      ...
      <div className="flex flex-row justify-between items-center mt-2 2xl:mt-6 font-acme">
      ...
      <div className="flex flex-row justify-between items-center font-acme mt-2 2xl:mt-6">
