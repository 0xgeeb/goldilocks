  ...
  return (
    <div className="w-[40%] h-[75%] bg-white border-2 border-black rounded-xl p-3 2xl:p-6 flex flex-col justify-around">
      ...
      <div className="flex flex-row justify-between items-center font-acme">
        ...
        <p className="text-[18px] 2xl:text-[20px]">${handleInfo((balance.staked - balance.locked) * (borrowInfo.fsl / borrowInfo.supply))}</p>
      </div>
      <div className="flex flex-row justify-between items-center font-acme ">
      ...
      <div className="flex flex-row justify-between items-center font-acme">
        ...
        <p className="text-[18px] 2xl:text-[20px]">{handleInfo(balance.locked)}</p>
      </div>
      <div className="flex flex-row justify-between items-center font-acme">
        <h1 className="text-[20px] 2xl:text-[24px]">borrowed $HONEY:</h1>
        <p className="text-[18px] 2xl:text-[20px]">{handleInfo(balance.borrowed)}</p>
      </div>
    </div>
  )
}