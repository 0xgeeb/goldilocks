    ...
    <>
      ...
      <div className="flex flex-row ml-2 items-center justify-between">
        ...
        <div className="flex flex-row bg-white rounded-2xl border-2 border-black">
          <div 
            className={`font-acme w-20 py-2 ${activeToggle === 'stake' ? "bg-[#ffff00]" : "bg-white"} hover:bg-[#d6d633] rounded-l-2xl text-center border-r-2 border-black cursor-pointer`} 
            onClick={() => changeActiveToggle('stake')}
          >
            stake
          </div>
          <div 
            className={`font-acme w-20 py-2 ${activeToggle === 'unstake' ? "bg-[#ffff00]" : "bg-white"} hover:bg-[#d6d633] text-center border-r-2 border-black cursor-pointer`} 
            onClick={() => changeActiveToggle('unstake')}
          >
            unstake
          </div>
          <div 
            className={`font-acme w-20 py-2 ${activeToggle === 'realize' ? "bg-[#ffff00]" : "bg-white"} hover:bg-[#d6d633] rounded-r-2xl text-center cursor-pointer`} 
