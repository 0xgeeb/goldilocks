...
//   /// @param _startingSize todo
//   /// @param _beraAddress todo
//   /// @param _gberaAddress todo
//   /// @param _collectionIDs todo
//   constructor(uint256 _startingSize, address _beraAddress, address _gberaAddress, bytes32[] memory _collectionIDs) {
//     bera = _beraAddress;
//     gbera = _gberaAddress;
...
//   /// @param amount Amount of $BERA to lock
//   function lock(uint256 amount) external {
//     //todo stake the deposited bera in the consensus vault
//     //todo add existing consensus vault rewards to lending pool
//     poolSize += amount;
//     //question clarification on ratio 
//     igBERA(gbera).mint(msg.sender, gberaRatio * amount);
//   }

//   /// @notice Stakes $gBERA
//   /// @param stakeAmount Amount of $gBERA to stake
//   function stake(uint256 stakeAmount) external {
//     //question should we transfer gbera
//     //todo change staked mapping to checking if a stakedposition exists
//     // if(staked[msg.sender] == false) {
//     if(1 == 1) {
//       stakeLookup[msg.sender] = StakedPosition({
...
//     }
//     else {
//       //question should we update lastClaim
...
//     if(stakeLookup[msg.sender].stakedBalance - unstakeAmount == 0){
//       //todo delete struct from mapping?
//       // think there is that bug that makes it bad to do this but check
//     }
...
//   function _isBera(address allegedBera) internal view returns (bool) {
//     return allegedBera == beraNFT;
//   }
